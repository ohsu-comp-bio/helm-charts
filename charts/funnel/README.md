...
![Version: 0.1.59-rc.2](https://img.shields.io/badge/Version-0.1.59--rc.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2025-10-01](https://img.shields.io/badge/AppVersion-2025--10--01-informational?style=flat-square)
...
| volumeMounts[1].name | string | `"worker-templates-volume"` |  |
